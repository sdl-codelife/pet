    ...
    <div class="main-layout-side">
        ...
        <ul class="layui-nav layui-nav-tree" lay-filter="leftNav">
            ...
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    <dd><a href="javascript:;" data-url="article-list.html" data-id='3' data-text="增加医生"><span class="l-line"></span>增加医生</a></dd>
                    <dd><a href="javascript:;" data-url="danye-list.html" data-id='9' data-text="查看医生"><span class="l-line"></span>查看医生</a></dd>
                </dl>
            </li>
            <li class="layui-nav-item">
                <a href="javascript:;"><i class="iconfont">&#xe608;</i>用户管理</a>
                <dl class="layui-nav-child">
                    <dd><a href="userlist.action" data-text="查看用户" target="iframe"><span class="l-line"></span>查看用户</a></dd>
                    <dd><a href="javascript:;" data-url="danye-list.html" data-id='9' data-text="增加用户" target="iframe"><span class="l-line"></span>增加用户</a></dd>
                </dl>
            </li>
            ...
            <div class="layui-tab layui-tab-brief main-layout-tab" lay-filter="tab" lay-allowClose="true">
                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show" style="background: #f5f5f5;">
                        ...
                        <iframe src="userinfo.action?userId=${user.userId}&userName=${user.userName}" width="100%" height="100%" name="iframe" scrolling="auto" class="iframe" framborder="0"></iframe>
                        <!--1end-->
                    </div>
                </div>
            </div>
