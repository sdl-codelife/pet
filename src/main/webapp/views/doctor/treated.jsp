...
<div class="layui-tab page-content-wrap">
    ...
    <div class="layui-tab-content">
        <form style="width:80%;" class="layui-form" action="seeDescription.action?description.dId=${description.dId}"
              method="get">
        ...
        <form action="tread.action" method="post">
            <div class="layui-tab-item layui-show">
                ...
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        <button class="layui-btn layui-btn-normal" lay-submit lay-filter="adminInfo">提交诊断</button>
                    </div>
                </div>
...
<script>document.getElementById("userInfos.userNote").value = "${description.description}"</script>
<script>
    //Demo
